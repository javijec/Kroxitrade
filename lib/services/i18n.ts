...
const translations = {
  en: {
    ...
    "settings.compactActionsTitle": "Compact Actions Menu",
    "settings.compactActionsDescription": "Show only main actions (Edit, Check, Delete) with others in a dropdown menu.",
    "about.eyebrow": "About",
...
const portugueseTranslations: Record<string, TranslationValue> = {
  ...
  "settings.compactActionsTitle": "Menu de ações compacto",
  "settings.compactActionsDescription": "Mostrar apenas as ações principais (Editar, Check, Excluir) com as outras em um menu suspenso.",
  "about.eyebrow": "Sobre",
...
const germanTranslations: Record<string, TranslationValue> = {
  ...
  "settings.compactActionsTitle": "Kompaktes Aktionsmenü",
  "settings.compactActionsDescription": "Nur die Hauptaktionen (Bearbeiten, Check, Löschen) mit anderen in einem Dropdown-Menü anzeigen.",
...
const frenchTranslations: Record<string, TranslationValue> = {
  ...
  "settings.visible": "Visible",
  "settings.compactActionsTitle": "Menu d'actions compact",
  "settings.compactActionsDescription": "Afficher uniquement les actions principales (Modifier, Check, Supprimer) avec les autres dans un menu déroulant.",
...
const russianTranslations: Record<string, TranslationValue> = {
  ...
  "settings.compactActionsTitle": "Компактное меню действий",
  "settings.compactActionsDescription": "Показывать только основные действия (Редактировать, Отметить, Удалить) с остальными в выпадающем меню.",
...
const thaiTranslations: Record<string, TranslationValue> = {
  ...
  "settings.compactActionsTitle": "เมนูการทำงานแบบกระชับ",
  "settings.compactActionsDescription": "แสดงเฉพาะการทำงานหลัก (แก้ไข, เช็ค, ลบ) พร้อมกับอื่นๆ ในเมนูดร็อปดาวน์",
...
const japaneseTranslations: Record<string, TranslationValue> = {
  ...
  "settings.hidden": "非表示",
  "settings.visible": "表示",
  "settings.compactActionsTitle": "コンパクトアクションメニュー",
  "settings.compactActionsDescription": "メインアクション（編集、チェック、削除）のみを表示し、他はドロップダウンメニューに表示します。",
  "about.eyebrow": "概要",
...
const koreanTranslations: Record<string, TranslationValue> = {
  ...
  "settings.hidden": "숨김",
  "settings.visible": "표시",
  "settings.compactActionsTitle": "컴팩트 액션 메뉴",
  "settings.compactActionsDescription": "메인 액션(편집, 체크, 삭제)만 표시하고 나머지는 드롭다운 메뉴에 표시합니다.",
  "about.eyebrow": "정보",
