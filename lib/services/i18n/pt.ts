...
export const portugueseTranslations: Record<string, TranslationValue> = {
  ...
  "whatsNew.item.lastSyncTimestampTitle": "Horário da última sincronização em Backup e restauração",
  "whatsNew.item.lastSyncTimestampDescription": "A seção de Backup e restauração agora mostra a data e a hora da sua sincronização mais recente, para você confirmar de relance que seus dados estão em dia.",
  ...
  "bookmarks.automaticSyncDescription":
    "Seus favoritos e configurações sincronizam automaticamente com o Chrome enquanto você usa a extensão.",
  "bookmarks.restoreFile": "Restaurar do arquivo",
  "bookmarks.lastSync": ({ date, time }) => `Última sincronização: ${date} às ${time}`,
  "bookmarks.lastSyncNever": "Última sincronização: nunca",
  ...
  "folder.dragCategory": "Arraste para reordenar a categoria",
  "folder.moveCategoryUp": "Mover categoria para cima",
  "folder.moveCategoryDown": "Mover categoria para baixo",
  "folder.dropCategoryAtEnd": "Solte para colocar a categoria no final",
  "folder.dragSaveError": "Não foi possível salvar a nova ordem.",
