...
export const russianTranslations: Record<string, TranslationValue> = {
  ...
  "whatsNew.item.refreshedDefaultsTitle": "Обновленные значения по умолчанию для более чистого начального вида",
  "whatsNew.item.refreshedDefaultsDescription": "Новые установки начинают работу с компактными макетами закладок и более сфокусированными элементами управления. Все параметры остаются доступны в настройках для персонализации рабочего процесса.",
  "whatsNew.item.quickFiltersPageInitTitle": "Быстрые фильтры возвращаются на страницу торговли",
  "whatsNew.item.quickFiltersPageInitDescription": "Быстрые фильтры теперь надежно инициализируются после загрузки синхронизированных настроек, поэтому размещение на странице работает в PoE1 и PoE2."
}
